...
export default async function StockPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-100 via-blue-50/40 to-violet-50/50 pb-24 lg:pb-0"><Sidebar /><section className="lg:pl-64">
      <header className="border-b border-white/70 bg-white/70 px-6 py-6 backdrop-blur-xl"><h1 className="text-2xl font-bold tracking-tight text-slate-950">StockMind</h1><p className="mt-1 text-sm text-slate-500">Monitor stock levels, predict stock-out risk, and get restock suggestions.</p></header>
