...
export default async function ReturnGuardPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100"><Sidebar /><section className="lg:pl-72">
      <header className="border-b border-slate-200 bg-white/80 px-6 py-5 backdrop-blur"><h1 className="text-2xl font-bold text-slate-950">ReturnGuard AI</h1><p className="mt-1 text-sm text-slate-500">Detect risky orders before shipping and suggest smart verification actions.</p></header>
